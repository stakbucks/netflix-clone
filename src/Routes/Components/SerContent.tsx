...
import { getSeriesLatest, getSeriesRec } from "../../api";
import { motion, AnimatePresence } from "framer-motion";
import { useState } from "react";
import { IGetSeries } from "../../api";
...
function SerContents() {
  const { data: latestData, isLoading: latestIsLoading } = useQuery<IGetSeries>(
    ["series", "latest"],
    getSeriesLatest
  );
  const { data: recData, isLoading: recIsLoading } = useQuery<IGetSeries>(
    ["series", "rec"],
    getSeriesRec
  );
                    ...
                    .map((series) => (
                      <>
                        ...
                        >
                          ...
                          />
                          <Box variants={boxVariants}>{series.name}</Box>
                        </Series>
                      </>
                    ))}
                </Row>
